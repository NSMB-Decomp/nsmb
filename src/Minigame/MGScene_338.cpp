...
const STRS MG_DEBUG_STRINGS = {
    {
	"HANACHAN", "SNOWBALL", "LUIGI", "COIN", "MEMORY", "BOMROOM", "PACHINKO", "TAMAIRE", "JUMP", "JUMP2", "AMIDA", "FLOWER", "BOMTHROW", "SPEED", "CARD", "TERESA", "BLACKJACK", "PANEL", "TRAMPOLINE2", "MOGURA", "TAMAYOKE", "INDIPORKER", "RIVERSI", "BALLOON", "SNOWWAR", "MCARLO", "TITLE",
    },
};
