...
u16 data_ov130_02139100[27] = {
    0x166, 0x169, 0x180, 0x16D,
    0x16E, 0x16F, 0x171, 0x172,
    0x167, 0x168, 0x16A, 0x16C,
    0x170, 0x175, 0x174, 0x173,
...
u32 MGScene_338::virt_19(u32 param_1)
{
    ...
    return (u32)MG_DEBUG_STRINGS[param_1];
}
