...
{
	return new VSMenuScene();
}

void VSMenuScene::func_ov052_02155cf8()
{
...
void VSMenuScene::func_ov052_02155c9c()
{
...
void VSMenuScene::func_ov052_02155ba8()
{
...
void VSMenuScene::func_ov052_02155b00() {
...
VSMenuScene::VSMenuScene() : initializedState(0)
{
}

VSMenuScene::~VSMenuScene()
{
}

s32 VSMenuScene::onCreate()
{
	func_02006ca4();
...
s32 VSMenuScene::onDestroy() {
	func_020180a4(&this->textLabel);
	System::resetSubBGVBlank();
	return true;
}

void VSMenuScene::pendingDestroy() {
}
...
s32 VSMenuScene::onUpdate() {
	static void (VSMenuScene::*ptmfs[20])() = {
		VSMenuScene::func_ov052_02155210,
		VSMenuScene::func_ov052_021551e4,
		VSMenuScene::func_ov052_0215515c,
		VSMenuScene::func_ov052_02154c9c,
		VSMenuScene::func_ov052_02154bb4,
		VSMenuScene::func_ov052_02154a60,
		VSMenuScene::func_ov052_0215476c,
		VSMenuScene::func_ov052_021546d0,
		VSMenuScene::func_ov052_02154698,
		VSMenuScene::func_ov052_0215459c,
		VSMenuScene::func_ov052_02154698,
		VSMenuScene::func_ov052_02155178,
		VSMenuScene::func_ov052_02154b64,
		VSMenuScene::func_ov052_02154af4,
		VSMenuScene::func_ov052_02154a24,
		VSMenuScene::func_ov052_0215454c,
		VSMenuScene::func_ov052_021544a0,
		VSMenuScene::func_ov052_02154c68,
		VSMenuScene::func_ov052_02154c34,
		VSMenuScene::func_ov052_021549f8
	};
	func_02021808();
...
s32 VSMenuScene::onRender() {
	static void (VSMenuScene::*ptmfs[20])() = {
		VSMenuScene::func_ov052_02154244,
		VSMenuScene::func_ov052_02154238,
		VSMenuScene::func_ov052_02154220,
		VSMenuScene::func_ov052_02153d5c,
		VSMenuScene::func_ov052_02153d14,
		VSMenuScene::func_ov052_02153d08,
		VSMenuScene::func_ov052_02153b44,
		VSMenuScene::func_ov052_02153b38,
		VSMenuScene::func_ov052_02153b04,
		VSMenuScene::func_ov052_02153ad0,
		VSMenuScene::func_ov052_02153b04,
		VSMenuScene::func_ov052_0215422c,
		VSMenuScene::func_ov052_02153d2c,
		VSMenuScene::func_ov052_02153d20,
		VSMenuScene::func_ov052_02153cfc,
		VSMenuScene::func_ov052_02153ac4,
		VSMenuScene::func_ov052_02153ab8,
		VSMenuScene::func_ov052_02153d50,
		VSMenuScene::func_ov052_02153d44,
		VSMenuScene::func_ov052_02153d38
	};
	(this->*ptmfs[this->state])();
	return true;
}

void VSMenuScene::func_ov052_02153ab8()
{
	func_ov052_02153b44();
}

void VSMenuScene::func_ov052_02153ac4()
{
	func_ov052_02153b44();
}

void VSMenuScene::func_ov052_02153ad0()
{
	if (data_ov052_0215c888 == 0) {
		func_ov052_02153d5c();
	} else {
...
void VSMenuScene::func_ov052_02153b04()
{
	if (data_ov052_0215c888 == 0) {
		func_ov052_02153d5c();
	} else {
...
void VSMenuScene::func_ov052_02153b38()
{
	func_ov052_02153b44();
}

void VSMenuScene::func_ov052_02153b44()
{
...
void VSMenuScene::func_ov052_02153cfc()
{
	func_ov052_02153b44();
}

void VSMenuScene::func_ov052_02153d08()
{
	func_ov052_02153b44();
}

void VSMenuScene::func_ov052_02153d14()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02153d20()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02153d2c()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02153d38()
{
	func_ov052_02153b44();
}

void VSMenuScene::func_ov052_02153d44()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02153d50()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02153d5c()
{
...
void VSMenuScene::func_ov052_0215515c()
{
	state = 3;
	selectionBackgroundPosition.x = mainBackgroundPosition.x;
	selectionBackgroundPosition.y = mainBackgroundPosition.y;
...
void VSMenuScene::func_ov052_021551e4()
{
...
void VSMenuScene::func_ov052_021549f8()
{
	REG_DISPCNT_SUB = (REG_DISPCNT_SUB & ~0x1f00) | 0x1e00;
	state = 6;
...
void VSMenuScene::func_ov052_02154698()
{
...
void VSMenuScene::func_ov052_021546d0()
{
...
void VSMenuScene::func_ov052_0215476c()
{
	u8 previousState;
...
void VSMenuScene::func_ov052_02154a24()
{
	func_ov052_021554dc();
...
void VSMenuScene::func_ov052_02154a60()
{
	func_ov052_02155ba8();
	REG_DISPCNT_SUB = (REG_DISPCNT_SUB & ~0x1f00) | 0x1c00;
...
void VSMenuScene::func_ov052_021554dc()
{
...
void VSMenuScene::func_ov052_0215454c()
{
...
void VSMenuScene::func_ov052_0215459c()
{
...
void VSMenuScene::func_ov052_021544a0()
{
...
void VSMenuScene::func_ov052_02154b64()
{
...
void VSMenuScene::func_ov052_02154bb4()
{
	s8 timer = selectionTimer;
	if (timer == 0) {
		if (data_ov052_0215c888 == 0) {
...
void VSMenuScene::func_ov052_02154af4()
{
	if (Math::expLerp(&mainBackgroundPosition.y, 0x100000, 0x300, 0x28000, 0x3000) == 0) {
...
void VSMenuScene::func_ov052_02155178()
{
	func_ov052_021554dc();
	selectionBackgroundPosition.x = mainBackgroundPosition.x;
	selectionBackgroundPosition.y = mainBackgroundPosition.y;
...
void VSMenuScene::func_ov052_02155210()
{
	func_ov052_021554dc();
	selectionBackgroundPosition.x = mainBackgroundPosition.x;
	selectionBackgroundPosition.y = mainBackgroundPosition.y;
...
void VSMenuScene::func_ov052_02154c34()
{
...
void VSMenuScene::func_ov052_02154c68()
{
...
void VSMenuScene::func_ov052_02154c9c()
{
	u8 oldToggle;
	u8 oldSelection;
	u8 oldOption0;
...
void VSMenuScene::func_ov052_02154220()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_0215422c()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02154238()
{
	func_ov052_02153d5c();
}

void VSMenuScene::func_ov052_02154244()
{
	func_ov052_02153d5c();
}
